...
### Logistic Model 5: Based on the entire dataset from the cleaned and imputed training dataset
```{r}
logist_model5 <- glm(TARGET_FLAG~., family=binomial, data = train_df_imp_log)

summary(logist_model5)
```
