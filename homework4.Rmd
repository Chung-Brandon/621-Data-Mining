...
```
```{r}
test_probs <- predict(logist_model1, newdata = test_df, type = "response")
...
```
```{r}
test_probs2 <- predict(logist_model2, newdata = test_df, type = "response")
...
```{r}
test_probs3 <- predict(logist_model3, newdata = test_df, type = "response")
